...
{
    /// @brief Calculates the area of an H3 cell in square kilometers.
    /// @details This function computes the spherical area of a specific H3 cell using its
    ...
    /// @ref cellAreaKm2
    ///
    /// @param cell The H3 cell index for which to calculate the area.
    ...
    /// @brief Calculates the area of an H3 cell in square meters.
    /// @details This function computes the spherical area of a specific H3 cell using its
    ///          geographic boundary. The calculation correctly accounts for the smaller area of
    ///          pentagonal cells compared to hexagonal cells at the same resolution.
    ///
    ...
    /// @brief Calculates the area of an H3 cell in square radians.
    /// @details This function computes the fundamental spherical area of a specific H3 cell
